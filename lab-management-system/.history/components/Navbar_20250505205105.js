                    ...
                    <div className="relative group">
                        ...
                        <div className="absolute right-0 mt-2 w-40 bg-white text-gray-800 rounded-xl shadow-2xl opacity-0 group-hover:opacity-100 group-hover:translate-y-0 transform -translate-y-3 transition-all duration-300 ease-in-out z-10">
                            <div className="relative group/sub">
                                ...
                                <div className="absolute right-40 top-0 w-40 bg-white text-gray-800 rounded-xl shadow-2xl opacity-0 group-hover/sub:opacity-100 group-hover/sub:translate-x-0 transform translate-x-3 transition-all duration-300 ease-in-out z-10">

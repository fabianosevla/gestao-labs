...
export default function Home() {
  ...
  const { user } = useAuth();
  const [isMounted, setIsMounted] = useState(false); // Estado para controlar montagem no cliente
  ...
  // Evita renderizar qualquer coisa no servidor até que o componente esteja montado
  if (!isMounted) {

...
export default function AdminUsers() {
    ...
    return (
        <div className="p-6 pt-28">
            <h1 className="text-3xl font-bold mb-6 text-gray-900">Usuários Admin</h1>
            <p className="text-gray-700 mb-6">Aqui você pode gerenciar os usuários administradores.</p>
                ...
                <table className="w-full border-collapse bg-white shadow-md rounded-lg">
                    <thead>
                        <tr className="bg-gray-100">
                            ...
                            <th className="border p-3 text-gray-900 font-semibold text-left">Senha</th>
                            <th className="border p-3 text-gray-900 font-semibold text-left">Data de Cadastro</th>
                    ...
                    <tbody>
                        {filteredUsers.map((user) => (
                            <tr key={user.id} className="hover:bg-gray-50">
                                ...
                                <td className="border p-3 text-gray-700">{user.password}</td>
                                <td className="border p-3 text-gray-700">{user.registerDate}</td>

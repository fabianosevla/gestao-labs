...
export default function EditMacroHardware() {
    ...
    useEffect(() => {
        ...
        // Verifique se macroHardwares é um array não vazio antes de prosseguir
        if (macroHardwares && Array.isArray(macroHardwares) && macroHardwares.length > 0) {
            ...
            if (hardware) {
                setFormData({
                    ...hardware,
                    // Garante que novos campos existam para evitar "undefined"
                    quantity: hardware.quantity || 1, // Padrão 1 se não existir
        ...
        <div className="p-6 pt-28">
            ...
            <form className="max-w-lg" onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                    ...
                    <select
                        id="quantity"
                        value={formData?.quantity || 1} // Padrão 1 se for nulo
                        onChange={handleChange}
                        className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900"
                        required
                    >

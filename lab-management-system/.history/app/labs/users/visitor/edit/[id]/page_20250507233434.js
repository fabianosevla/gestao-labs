...
export default function EditVisitorUser() {
    ...
    useEffect(() => {
        ...
        // Verifique se visitorUsers é um array não vazio antes de prosseguir
        if (visitorUsers && Array.isArray(visitorUsers) && visitorUsers.length > 0) {
    ...
    }, [id, loading, router, visitorUsers]);

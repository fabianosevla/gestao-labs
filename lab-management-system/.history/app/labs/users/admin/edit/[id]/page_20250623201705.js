// app/labs/users/admin/edit/[id]/page.js
"use client";
...
export default function EditAdminUser() {
    ...
    useEffect(() => {
        ...
        if (adminUsers && Array.isArray(adminUsers) && adminUsers.length > 0) {
            ...
            if (adminUser) {
                setFormData({ ...adminUser, role: adminUser.role || "user" }); // Padrão 'user' se role não definida
            } else {
        ...
        <div className="p-6 pt-28">
            ...
            <form className="max-w-lg" onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                    ...
                    <select
                        id="role"
                        value={formData?.role || "user"} // Padrão 'user' se role não definida
                        onChange={handleChange}
                        className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900"
                        required
                        autoComplete="off"

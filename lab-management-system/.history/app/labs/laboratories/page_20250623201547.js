                ...
                <table className="w-full border-collapse bg-white shadow-md rounded-lg">
                    <thead>
                        <tr className="bg-gray-100">
                            ...
                            <th className="border p-3 text-gray-900 font-semibold text-left">Sigla</th>
                        ...
                        {filteredLaboratories.map((lab) => {
                            ...
                            return (
                                <tr key={lab.id.toString()} className="hover:bg-gray-50">
                                    ...
                                    <td className="border p-3 text-gray-700">{lab.acronym || "N/A"}</td>
                                    <td className="border p-3 text-gray-700">{lab.capacity || "N/A"}</td>

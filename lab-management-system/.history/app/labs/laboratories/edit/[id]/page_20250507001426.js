...
export default function EditLaboratory() {
    ...
    const handleSubmit = async (e) => {
        ...
        const updatedLaboratories = laboratories.map((l) =>
            l.id === parseInt(id) ? { ...formData, capacity: parseInt(formData.capacity), responsibleId: parseInt(formData.responsibleId) } : l
        );
        await setLaboratories(updatedLaboratories);
        router.push("/labs/laboratories");
    };

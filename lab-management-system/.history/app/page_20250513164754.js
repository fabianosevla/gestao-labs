  ...
  return (
    <div className="p-6">
      ...
      <div className="mt-8">
        <button
          onClick={openModal}
          className="px-6 py-3 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition duration-300"
        >
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-lg">
            ...
            <div className="flex flex-col space-y-3">
              <button
                ...
                className="px-4 py-2 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition duration-300"
              >

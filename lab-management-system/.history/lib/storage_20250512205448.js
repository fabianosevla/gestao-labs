...
export async function addMicroHardware(data) {
    try {
        ...
        if (newHardware) {
            // Chama refresh para atualizar a lista
            const [, setMicroHardwares, , refreshMicroHardwares] = useMicroHardwares();
...
export async function addMacroHardware(data) {
    try {
        ...
        const newHardware = await response.json();
        if (newHardware) {
            const [, setMacroHardwares, , refreshMacroHardwares] = useMacroHardwares();
...
export async function addSoftware(data) {
    try {
        ...
        if (newSoftware) {
            const [, setSoftwares, , refreshSoftwares] = useSoftwares();
...
export async function addLaboratory(data) {
    try {
        ...
        if (newLab) {
            const [, setLaboratories, , refreshLaboratories] = useLaboratories();
...
export async function addAdminUser(data) {
    try {
        ...
        if (newUser) {
            const [, setAdminUsers, , refreshAdminUsers] = useAdminUsers();
...
export async function addVisitorUser(data) {
    try {
        ...
        const newUser = await response.json();
        if (newUser) {
            const [, setVisitorUsers, , refreshVisitorUsers] = useVisitorUsers();

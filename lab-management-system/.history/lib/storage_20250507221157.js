...
// Simulação de uma "base de dados" local para laboratórios, usuários, hardwares e softwares
let laboratoriesData = [
    { id: 1, name: "Laboratório A", userId: 1 },
    { id: 2, name: "Laboratório B", userId: null },
];
let adminUsersData = [
    { id: 1, name: "Admin João" },
    { id: 2, name: "Admin Maria" },
];
let visitorUsersData = [
    { id: 1, name: "Visitante Pedro" },
    { id: 2, name: "Visitante Ana" },
];
let macroHardwaresData = [
    { id: 1, name: "Macro HW 1", laboratoryId: 1, userId: "admin-1", status: "ativo" },
];
let microHardwaresData = [
    { id: 1, name: "Micro HW 1", laboratoryId: 1, userId: 1, status: "ativo" },
];
let softwaresData = [
    { id: 1, name: "Software 1", laboratoryId: 1, userId: 1, status: "ativo" },
];
...
export function useLaboratories() {
    ...
    const refreshLaboratories = async () => {
        setLoading(true);
        // Simulação de uma chamada assíncrona (pode ser substituído por uma API real)
...
export async function deleteAdminUser(id) {
    ...
    // Atualizar laboratórios, hardwares e softwares que referenciam esse usuário

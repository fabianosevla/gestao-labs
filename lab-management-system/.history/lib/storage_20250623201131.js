...
export function useLaboratories() {
    ...
    return [laboratories, loading, refreshLaboratories];
}
...
export function useAdminUsers() {
    ...
    return [adminUsers, loading, refreshAdminUsers];
}
...
export function useVisitorUsers() {
    ...
    return [visitorUsers, loading, refreshVisitorUsers];
}
...
export function useMacroHardwares() {
    ...
    return [macroHardwares, loading, refreshMacroHardwares];
}
...
export function useMicroHardwares() {
    ...
    return [microHardwares, loading, refreshMicroHardwares];
}
...
export function useSoftwares() {
    ...
    return [softwares, loading, refreshSoftwares];
}

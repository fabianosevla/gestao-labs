...
export default function AdminUsers() {
    ...
    return (
        <div className="p-6 pt-28">
            <h1 className="text-3xl font-bold mb-6 text-gray-900">Administradores</h1>
            <p className="text-gray-700 mb-6">Aqui você pode gerenciar os administradores do sistema.</p>

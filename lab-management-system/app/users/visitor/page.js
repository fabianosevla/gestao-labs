...
export default function VisitorUsers() {
    ...
    const handleDelete = (id) => {
        const updatedUsers = visitorUsers.filter((u) => u.id !== id);
        setVisitorUsers(updatedUsers);
    };

    const filteredUsers = visitorUsers.filter((user) => {
    ...
    return (
        <div className="p-6 pt-28">
            ...
            <p className="text-gray-700 mb-6">Aqui você pode gerenciar os usuários visitantes.</p>
                ...
                <table className="w-full border-collapse bg-white shadow-md rounded-lg">
                    <thead>
                        <tr className="bg-gray-100">
                            ...
                            <th className="border p-3 text-gray-900 font-semibold text-left">Data de Visita</th>
